...
public class CC {
    ...
    static {
        ...
        CC.MENU_BAR = String.valueOf(String.valueOf(String.valueOf(ChatColor.GRAY.toString()))) + ChatColor.STRIKETHROUGH.toString() + "------------------------";
        CC.CHAT_BAR = String.valueOf(String.valueOf(String.valueOf(ChatColor.GRAY.toString()))) + ChatColor.STRIKETHROUGH.toString() + "------------------------------------------------";
        CC.SB_BAR = String.valueOf(String.valueOf(String.valueOf(ChatColor.GRAY.toString()))) + ChatColor.STRIKETHROUGH.toString() + "----------------------";
    }

    public static ChatColor fromBukkit(final ChatColor chatColor) {
        return ChatColor.values()[chatColor.ordinal()];
    }

    public static String colors(final String in) {
